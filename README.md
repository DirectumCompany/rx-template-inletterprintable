...
А так же неоходимо обновить сторонние библиотеку и MEDOSerializingXML в модуле "PrintableTemplate". Необходимо взять эту библиотеку из модуля "MEDO" решения Интеграция с МЭДО.
